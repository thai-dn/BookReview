class BooksController < ApplicationController
  before_action :authenticate_user!, except: %w[search index show]
  ...
  def book_params
    params.require(:book).permit(:title, :description, :author, :category_id, :book_img, :avatar, :avatar_cache, tags_attributes: [:id, :name, :description, :_destroy])  
  end
